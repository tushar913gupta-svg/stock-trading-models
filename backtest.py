...
def evaluate(ticker, actor):
    ...
    return (final_profit/env.initial_balance)*100

industries = {
    "semiconductor_stocks.keras": [
        "AMAT","TXN","ON","INTC","QCOM","MU","NVDA","ADI","AVGO","NXPI",
        "SWKS","CRUS","MCHP","MRVL","KLAC"
    ],
    "industrial_stocks.keras": [
        "CAT","DE","MMM","HON","GE","ETN","EMR","PCAR","GD","LHX",
        "NOC","IR","JCI","ITW","DOV"
    ],
    "pharma_stocks.keras": [
        "PFE","BMY","GSK","MRK","LLY","ABT","AMGN","JNJ","ZTS","BIIB",
        "MRNA","REGN","VRTX","GILD","NVAX"
    ],
    "logistics_stocks.keras": [
        "UPS","FDX","CSX","NSC","UNP","DAL","AAL","UAL","LUV","JBHT",
        "ODFL","CHRW","R","EXPD","SAIA"
    ],
    "finance_stocks.keras": [
        "JPM","GS","BAC","WFC","MS","SCHW","USB","PNC","AIG","CB",
        "TRV","BLK","TROW","SPGI","ICE"
    ],
    "fintech_stocks_alt.keras": [
        "PYPL","FISV","FICO","V","MA","FIS","GPN","ADP",
        "JKHY","EEFT","FOUR","MQ","AFRM"
    ],
    "ecom_stocks.keras": [
        "WMT","COST","TGT","HD","LOW","BBY","KR","TJX","ROST","M",
        "DG","DLTR","AMZN","BURL","WSM"
    ],
    "tech_stocks_alt.keras": [
        "IBM","ORCL","ACN","CRM","MSFT","AAPL","GOOGL","META","ADBE","INTU",
        "NOW","HPQ","DELL","CSCO","AMD"
    ]
}
